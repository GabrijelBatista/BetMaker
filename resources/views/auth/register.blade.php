    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card" id="mc2">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                            <label for="name" class="col-md-4 col-form-label text-md-right">{{ __('text.namereg') }}</label>
                ...
                <a style="text-decoration:underline;color:white; margin-bottom:10px; margin-left:10px" href="{{ route('login') }}">{{ __('text.youalreadyhaveanaccount') }}</a>
            </div>
        </div>
    </div>
</div>
